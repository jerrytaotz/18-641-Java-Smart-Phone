...
public class CarModels {
	...
	public void setAutomobile(Properties props) throws AutoException {
		Automobile auto = null;
		auto = new FileIO().buildAutoObject(props, auto);
		carsLists.put(auto.getName(), auto);
	}
	...
	public ArrayList<String> getModelList() {
		...
		Set<String> key_temp = CarModels.carsLists.keySet();
		for(String item: key_temp) {
			key.add(item);
		}
		return key;
	}
	
	public Properties getAutoProperty(String modelname) throws AutoException {
		Properties prop = new Properties();
		Automobile auto = this.getAutomobile(modelname);
		prop = new FileIO().autoToProperties(auto);
		return prop;
	}
	
	public Properties getAutoFile(String fileName, String fileType) throws AutoException {
		Properties prop = new FileIO().getObject(fileName, fileType);
		return prop;
	}
