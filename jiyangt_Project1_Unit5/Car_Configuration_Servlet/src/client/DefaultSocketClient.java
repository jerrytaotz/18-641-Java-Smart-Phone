...
//            this.bufferedReader = new BufferedReader(new InputStreamReader(socket.getInputStream()));
	...
	public void handleSession() {
		...
		inputString = this.inputDetect(this.objectInputStream).toString();
...
//			}
			else if(inputString.equals(CHOOSE_MODEL_REQUIRE)) {
				try {
					String client_choice = type_in.readLine();
					this.outputObject(client_choice);
				} catch (IOException e) {
				...
				Properties prop = (Properties) this.inputDetect(this.objectInputStream);
	...
	public Object inputDetect(ObjectInputStream objectInputStream) {
		Object result = null;
		try {
