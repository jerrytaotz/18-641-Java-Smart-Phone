...
The main change different from the part A, is that part B uses linkedHashMap to store multiple car models. Use ArrayList instead of normal array, the code can be much simpler.